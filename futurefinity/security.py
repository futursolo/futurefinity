...
class HMACSecurityContext(BaseSecurityContext):
    ...
    def lookup_origin_text(self, secure_text: str,
        ...
        hash = hmac.new(iv + ensure_bytes(self._security_secret),
...
class AESGCMSecurityContext(BaseSecurityContext):
    ...
    **This is the default security context of FutureFinity.**
    ...
    def lookup_origin_text(self, secure_text: str,
        ...
        :arg secure_text: This is a base64 encoded string, which contains
            the generated time, the content, and a AES GCM tag.
        :arg valid_length: The time length that the content should be valid.
            The unit is second. It you want the content be always valid, set
            the length to ``None``.
        """
        ...
        decryptor = AESCipher(
            aes_algorithms.AES(ensure_bytes(self._security_secret)),
